...
describe("Padding", () => {
    test("parsing", () => {
        ...
        const byte_array = Binary_Array(Uint(8), Padding({bytes: 1}), Uint(8));
    ...
    describe("Packing", () => {
        ...
        describe("Given no DataView", () => {
            test("bytes & bits", () => {
                const byte_array = Binary_Array(Uint(8), Padding({bytes: 1, bits: 4}), Bits(4), Uint(8));
...
describe("Binary_Array", () => {
    describe("Parsing", () => {
        test("parse a single byte", () => {
            ...
            const byte_array = Binary_Array(Uint(8));
        ...
        test("embedded arrays", () => {
            ...
            const byte_array = Binary_Array(Uint(8), Embed(Binary_Array(Uint(8), Uint(8))), Uint(8));
    ...
    describe("Packing", () => {
        describe("Given DataView", () => {
            test("pack some bytes", () => {
                const byte_array = Binary_Array(Uint(8), Uint(8), Uint(8));
            ...
            test("nest an array", () => {
                const byte_array = Binary_Array(Uint(8), Binary_Array(Uint(8), Uint(8)), Uint(8));
                const data_view = new DataView(new ArrayBuffer(4));
            ...
            test("pack some bits & bytes", () => {
                const byte_array = Binary_Array(Bits(2), Uint(8), Uint(8), Bits(6));
                const data_view = new DataView(new ArrayBuffer(3));
...
describe("Binary_Map", () => {
    describe("Parsing", () => {
        ...
        test("parse a byte", () => {
            const data_view = new DataView(new Uint8Array([42]).buffer);
            const byte_map = Binary_Map({decode}).set('a_byte', Uint(8));
        ...
        test("embedded maps", () => {
            const data_view = new DataView(new Uint8Array([0, 1, 2, 3]).buffer);
            const byte_map = Binary_Map({decode}).set('a', Uint(8)).set('embedded', Embed(Binary_Map().set('b', Uint(8)).set('c', Uint(8)))).set('d', Uint(8));
    ...
    describe("Packing", () => {
        describe("Given DataView", () => {
            test("pack a byte", () => {
                const byte_map = Binary_Map().set('one', Uint(8));
