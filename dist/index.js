...
export { inspect, Bits, Uint, Int, Float, Utf8, Embed, Byte_Array, Byte_Array_Class, /* Will be unnecessary in next TypeScript release */ Byte_Map, Byte_Map_Class, /* Will be unnecessary in next TypeScript release */ Byte_Buffer, Repeat, Branch, Padding } from './transcode';
